...
- 英文 康軒 九上 第一次段考：**37 份真卷 → 1797 題**（選606/閱讀494/非選457/聽力240）。聽力題標 `needsAudio`（無音檔，待 TTS），出卷自動排除。
- 合計 exambank.js **3932 題**（數146＋國220＋自1769＋英1797）。`aggregate.py` 可累積：重跑同切片＝刷新該 paperId、跑新切片＝累加，不覆蓋。
...
- 進度：九年級已完成 自然48、英文37；**待續**：國文(5/29,補24)、數學(6/27,補21),再其他版本(南一/翰林)、其他段考(二/三次)、下學期,然後八年級、七年級。社會科來源幾乎空,略過。
