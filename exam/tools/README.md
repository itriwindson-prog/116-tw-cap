...
## 已完成切片 —— 九年級康軒 全五段考(上1/2/3 + 下1/2)四科全數位化 ✅
**第一次段考(prefix …u1e1)**:數學27/國文27/自然48/英文37 = 139份、5405題。
**第二次段考(prefix …u2e)**:自然37/英文30/國文20/數學21 = 108份、+約4200題。
**第三次段考(prefix …u3e,2026-09 triage v2 首用)**:數27/國25/自35/英33 = 120份、+約4499題。國文跳過2誤置卷;自然剔除2份來源無答案卷(同德108)。踩到並修正「跨校配對」bug(見下)與 section 變體正規化。
**下學期第一次段考(prefix …d1e)**:數23/國22/自37/英31 = 113份、+約4176題。國文跳過1誤置+剔除1截斷答案卷;修正「克漏字去重誤刪」bug(aggregate 去重改 paperId-aware,同卷內保留)。
**下學期第二次段考(prefix …d2e)**:數19/國16/自27/英20 = 82份。**題庫達 21,429 題**(數2854/國4719/自6658/英7198)。國文剔2錯置+跳1誤置;自然剔2份無答案卷。

### 🎉 九年級康軒 全五段考(上1/2/3 + 下1/2)四科全數位化完成 = 562份、21,429題
